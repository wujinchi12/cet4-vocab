...
export const getPosList = (params = {}) => api.get('/words/pos/list', { params })
export const getWord = (id) => api.get(`/words/${id}`)
export const getProgressSummary = () => api.get('/progress')
export const getDueWords = (params = {}) => api.get('/progress/due', { params })
export const updateProgress = (wordId, knewIt) => api.put(`/progress/${wordId}`, { knew_it: knewIt })
export const getWeakestWords = (params = {}) => api.get('/progress/weakest', { params })
